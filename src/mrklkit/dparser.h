...
mnbytes_t *rt_parser_info_data_mpool(rt_parser_info_t *);
mnbytes_t *rt_parser_info_data(rt_parser_info_t *);
...
mnbytes_t *dparse_struct_item_ra_str(rt_parser_info_t *, int64_t);
...
rt_dict_t *dparse_dict_from_bytes(lkit_dpdict_t *, mnbytes_t *);
rt_array_t *dparse_array_from_bytes(lkit_dparray_t *, mnbytes_t *);

off_t dparse_pi_pos(rt_parser_info_t *);

typedef int (*dparser_read_lines_cb_t)(mnbytestream_t *,
                                       const byterange_t *,
                                       void *);
