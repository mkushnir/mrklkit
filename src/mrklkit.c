...
"(sym mrklkit_rt_struct_set_item_int_gc     (func void undef int int))\n"
"(sym mrklkit_rt_struct_set_item_float      (func void undef int float))\n"
"(sym mrklkit_rt_struct_set_item_float_gc   (func void undef int float))\n"
"(sym mrklkit_rt_struct_set_item_bool       (func void undef int bool))\n"
"(sym mrklkit_rt_struct_set_item_bool_gc    (func void undef int bool))\n"
"(sym mrklkit_rt_struct_set_item_str        (func void undef int str))\n"
"(sym mrklkit_rt_struct_set_item_str_gc     (func void undef int str))\n"
"(sym mrklkit_rt_struct_set_item_array      (func void undef int any))\n"
"(sym mrklkit_rt_struct_set_item_array_gc   (func void undef int any))\n"
"(sym mrklkit_rt_struct_set_item_dict       (func void undef int any))\n"
"(sym mrklkit_rt_struct_set_item_dict_gc    (func void undef int any))\n"
"(sym mrklkit_rt_struct_set_item_struct     (func void undef int any))\n"
"(sym mrklkit_rt_struct_set_item_struct_gc  (func void undef int any))\n"
...
"(sym mrklkit_rt_dict_get_item_array        (func any (dict str) str any))\n"
"(sym mrklkit_rt_dict_get_item_struct       (func any (dict str) str any))\n"
"(sym mrklkit_rt_dict_get_item_dict         (func any (dict str) str any))\n"
"(sym mrklkit_rt_dict_set_item_int          (func void undef str int))\n"
"(sym mrklkit_rt_dict_set_item_int_gc       (func void undef str int))\n"
"(sym mrklkit_rt_dict_set_item_float        (func void undef str float))\n"
"(sym mrklkit_rt_dict_set_item_float_gc     (func void undef str float))\n"
"(sym mrklkit_rt_dict_set_item_bool         (func void undef str bool))\n"
"(sym mrklkit_rt_dict_set_item_bool_gc      (func void undef str bool))\n"
"(sym mrklkit_rt_dict_set_item_str          (func void undef str str))\n"
"(sym mrklkit_rt_dict_set_item_str_gc       (func void undef str str))\n"
"(sym mrklkit_rt_dict_set_item_array        (func void undef str any))\n"
"(sym mrklkit_rt_dict_set_item_array_gc     (func void undef str any))\n"
"(sym mrklkit_rt_dict_set_item_dict         (func void undef str any))\n"
"(sym mrklkit_rt_dict_set_item_dict_gc      (func void undef str any))\n"
"(sym mrklkit_rt_dict_set_item_struct       (func void undef str any))\n"
"(sym mrklkit_rt_dict_set_item_struct_gc    (func void undef str any))\n"
...
"(sym mrklkit_rt_bytes_destroy (func void any))\n"
...
"\n"
"; builtin\n"
"(builtin dp-new (func undef ty undef))\n"
...
"(builtin dp-get (func undef undef undef undef))\n"
