...
"; mrklkit backend\n"
"(sym dparse_struct_item_int (func int undef int))\n"
"(sym dparse_struct_item_float (func float undef int))\n"
"(sym dparse_struct_item_bool (func bool undef int))\n"
"(sym dparse_struct_item_str (func str undef int))\n"
"(sym dparse_struct_item_array (func any undef int))\n"
"(sym dparse_struct_item_struct (func any undef int))\n"
"(sym dparse_struct_item_dict (func any undef int))\n"
