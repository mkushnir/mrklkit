...
"(sym mrklkit_rt_get_struct_item_int    (func int undef int int))\n"
"(sym mrklkit_rt_get_struct_item_float  (func float undef int float))\n"
"(sym mrklkit_rt_get_struct_item_bool   (func bool undef int bool))\n"
"(sym mrklkit_rt_get_struct_item_str    (func str undef int str))\n"
"(sym mrklkit_rt_get_struct_item_array  (func any undef int any))\n"
"(sym mrklkit_rt_get_struct_item_struct (func any undef int any))\n"
"(sym mrklkit_rt_get_struct_item_dict   (func any undef int any))\n"
"(sym mrklkit_rt_set_struct_item_int    (func void undef int int))\n"
"(sym mrklkit_rt_set_struct_item_float  (func void undef int float))\n"
"(sym mrklkit_rt_set_struct_item_bool   (func void undef int bool))\n"
"(sym mrklkit_rt_set_struct_item_str    (func void undef int str))\n"
"(sym mrklkit_rt_set_struct_item_dict   (func void undef int any))\n"
...
"(sym mrklkit_rt_get_dict_item_struct   (func any (dict str) str any))\n"
"(sym mrklkit_rt_set_dict_item_int      (func void undef str int))\n"
"(sym mrklkit_rt_set_dict_item_float    (func void undef str float))\n"
"(sym mrklkit_rt_set_dict_item_bool     (func void undef str bool))\n"
"(sym mrklkit_rt_set_dict_item_str      (func void undef str str))\n"
"(sym mrklkit_rt_set_dict_item_array    (func void undef str any))\n"
